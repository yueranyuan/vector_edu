...
ALL_PARAMS['emotiv_wide_search_finer_freq_bins'] = combine_dict(ALL_PARAMS['emotiv_wide_search2'],
                                                                {'finer_freq_bins': 1})
ALL_PARAMS['emotiv_wide_search_larger_intervals'] = combine_dict(ALL_PARAMS['emotiv_wide_search2'],
                                                                {'larger_intervals': 1})
